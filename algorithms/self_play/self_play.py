...
class SelfPlay(Trainable):

    def _setup(self, config):
        config = merge_dicts(SELF_PLAY_CONFIG, config)
        ...
        if self._symmetric:
            ...
            policies_to_train = list(policies.keys()) # We initially train all policies
        ...
        # Should we built separate trainables for the exploitation agents?
    ...
    def _train(self):
        ...
        results["self_play_rounds"] = self._self_play_round  # Whatever we do, we need to add a self-play round counter
